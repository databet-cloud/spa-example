	...
	testCases := []struct {
	...
	}{
		{
			...
			patches: map[string]json.RawMessage{
				...
				"start_time":    json.RawMessage(`"2022-01-02T15:04:05Z"`),
				"live_coverage": json.RawMessage(`true`),
				"venue":         json.RawMessage(`{"id": "venue2"}`),
				"tournament":    json.RawMessage(`{"id": "id2", "name": "name2", "master_id": "masterID2", "country_code": "country2"}`),
				"competitors": json.RawMessage(`{"competitor1": {
					"id": "competitor1",
					"meta": {},
					"name": "team1",
					"type": 2,
				...
				"streams": json.RawMessage(`{"stream1": {
					"id": "stream1",
					"locale": "locale1",
					"url": "url1",
					"platforms": {
